...
export default function DepositDOGE() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        ...
        >
          <TokenDOGE variant="branded" className="size-24" />
          <p className="text-sm font-semibold">
            DOGE <span className="text-xs font-normal">Dodge</span>
          </p>
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Deposit DOGE</DialogTitle>
        </DialogHeader>
        {/* alert */}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Minimum amount of DOGE is 0.0005.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
